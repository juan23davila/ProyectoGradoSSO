...
$config = array(
	...
	'example-sql' => array(
		'sqlauth:SQL',
		'dsn' => 'mysql:host=idp.anfho.com;port=3306;dbname=SSO_Uniquindio',
		'username' => 'root',
		'password' => '',
		'query' => 'SELECT username, nombre, correo FROM Usuario WHERE username = :username AND password = :password',
	),
